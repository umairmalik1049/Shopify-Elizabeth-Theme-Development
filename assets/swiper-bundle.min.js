...
var Swiper = (function () {
            ...
            for (let s = 0, a = e.length; s < a; s += 1) {
               ...
               void 0 !== r &&
                  ...
                  (c(t[a]) && c(i[a])
                     ...
                     : !c(t[a]) && c(i[a])
                     ? ((t[a] = {}),
                       i[a].__swiper__ ? (t[a] = i[a]) : u(t[a], i[a]))
                     : (t[a] = i[a]));
            }
         }
      }
   ...
   var H = {
      ...
      updateSlides: function () {
         ...
         if (
            ...
            (p = t),
               Math.floor(e.virtualSize - E) - Math.floor(p[p.length - 1]) >
                  1 && p.push(e.virtualSize - E);
         }
         if (l && s.loop) {
            const t = h[0] + x;
   ...
   var q = {
      ...
      loopFix: function ({
         ...
         d.length < y + x ||
         ("cards" === o.params.effect && d.length < y + 2 * x)
            ? v(
         ...
         let A = 0,
            $ = 0;
         const k =
            (S ? d[i].column : i) + (b && void 0 === a ? -y / 2 + 0.5 : 0);
         if (k < x) {
            A = Math.max(x - k, E);
   ...
   function F(e) {
      ...
      if ("touchstart" === i.type)
         return void _(t, i, i.targetTouches[0].pageX);
   ...
   const we = [
      function ({ swiper: e, extendParams: t, on: s, emit: i }) {
         ...
         function d(t, s, a) {
            ...
            n
               ? ((S = Math.floor(x / 2) + r + u),
                 (T = Math.floor(x / 2) + r + p))
               : ((S = x + (r - 1) + u), (T = (d ? x : r) + p));
            let M = y - T,
               C = y + S;
            ...
            if (
               ...
               return (
                  e.slidesGrid !== w &&
                     ...
                     e.slides.forEach((t) => {
                        t.style[E] =
                           P - Math.abs(e.cssOverflowAdjustment()) + "px";
                     }),
                  e.updateProgress(),
         ...
         function o(t) {
            ...
            if (
               ...
               if (
                  ...
                  let t = !1;
                  if (
                     x(e.el, `.${e.params.slideClass}, swiper-slide`).length >
                        0 &&
            ...
            c.forEach((t, r) => {
               if (
                  ...
                  "horizontal" === a ? (n = r) : (l = r),
                     t
                        .querySelectorAll(oe(s.progressbarFillClass))
                        .forEach((t) => {
         ...
         function C() {
            ...
            e.params.uniqueNavElements &&
               ...
               i &&
                  ...
                  l ||
                     ((l = w("div", e.params.scrollbar.dragClass)),
                     i.append(l))),
      ...
      function ({ swiper: e, extendParams: t, on: s, emit: a }) {
         ...
         function M(t) {
            ...
            return (
               !!t.target.matches(s) ||
               [...e.hostEl.querySelectorAll(s)].filter((e) =>
                  e.contains(t.target)
               ).length > 0
            );
         }
         function C(t) {
            if (("mouse" === t.pointerType && m.splice(0, m.length), !T(t)))
               return;
            ...
            if (((n = !1), (l = !1), m.push(t), !(m.length < 2))) {
               ...
               if (h.imageEl) {
                  const [e, t] = (function () {
                     ...
                     return [
                        (m[0].pageX +
                           (m[1].pageX - m[0].pageX) / 2 -
                           e.x -
                           i.scrollX) /
                           o,
                        (m[0].pageY +
                           (m[1].pageY - m[0].pageY) / 2 -
                           e.y -
                           i.scrollY) /
                           o,
                     ];
                     ...
                     v() &&
                        e.pagination.bullets.forEach((s) => {
                           e.params.pagination.clickable &&
                              ...
                              s.matches(
                                 oe(e.params.pagination.bulletActiveClass)
                              )
         ...
         const d = () => {
            ...
            c = () => {
               ...
               o.history.replaceState
                  ? (o.history.replaceState(null, null, `#${a}` || ""),
                    s("hashSet"))
         ...
         s("init", () => {
            ...
            (e.grid = {
               initSlides: (t) => {
                  ...
                  (r = Math.floor(o / n)),
                     (a =
                        Math.floor(o / n) === o / n ? o : Math.ceil(o / n) * n),
                  ...
                  if ("row" === p && o > 1) {
                     const e = Math.floor(t / (o * c)),
                        ...
                        r =
                           0 === e
                              ? o
                              : Math.min(Math.ceil((u - e * c * o) / c), o);
                     (f = Math.floor(i / r)),
                        (h = i - f * r + e * o),
                        (m = h + (f * a) / c),
                        (s.style.order = m);
               ...
               p.shadow &&
                  (u
                     ? ((h = e.wrapperEl.querySelector(".swiper-cube-shadow")),
                       h ||
                          ((h = w("div", "swiper-cube-shadow")),
                          e.wrapperEl.append(h)),
                       (h.style.height = `${r}px`))
                     : ((h = t.querySelector(".swiper-cube-shadow")),
                       h ||
                          ((h = w("div", "swiper-cube-shadow")), t.append(h))));
               for (let e = 0; e < i.length; e += 1) {
                  const t = i[e];
                  let s = e;
                  m &&
                  ...
                  for (let e = 0, t = a.length; e < t; e += 1) {
                     ...
                     if (
                        ...
                        e || (e = ve("coverflow", t, n ? "left" : "top")),
                           s ||
                              (s = ve("coverflow", t, n ? "right" : "bottom")),
